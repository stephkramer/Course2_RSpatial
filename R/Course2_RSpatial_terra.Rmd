...
* https://rspatial.org/   <br>  
* http://pakillo.github.io/R-GIS-tutorial/    <br>  
...
<br>
**4. Overview of spatial packages** <br>  
...
*  and nice intro: https://oliviergimenez.github.io/introspatialR/#1  <br>  
...
#### Transformations between simple feature '{sf}' and Spatial*DataFrame '{sp}'
...
has already a CRS, e.g. WGS84 (angular units, longitude and latitude), and you want to change into a projection
with planar units (e.g. meters)
...
[`{rnaturalearth}`](https://docs.ropensci.org/rnaturalearth) (https://docs.ropensci.org/rnaturalearth) is an R package to hold and facilitate interaction with NaturalEarth map data. 
...
We first need to define our query and limit it to a region. ou can explore the features and tags (also available as information via OpenStreetMap directly).
...
We first need to define a location or bounding box for our elevation data. This can either be a daat frame or a spatial object. We use an `sf` object which holds the projection to be used when assessing the elevation data:
...
Now we can download the elevation data with a specified resolution (ranging from 1 to 14 with 1 being very coarse and 14 being very fine).
